...
export function EnhancedHomepage({ structuredData }: { structuredData: any }) {
  ...
  useEffect(() => {
    // Force repaint of decorative elements during scroll to prevent them from disappearing
    const handleScroll = () => {
