...
export const metadata: Metadata = {
  title: "Reach Out | Ascent Classes",
  description:
    "Contact Ascent Classes for inquiries, feedback, or support. We're here to help you with your academic journey.",
}
      ...
      <FadeIn>
        <div className="text-center mb-16">
          <SectionHeading
            ...
            description="Contact us for inquiries, feedback, or support. We're here to help you with your academic journey."
          />
        </div>
      </FadeIn>
              ...
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[900px] text-slate-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-slate-400">
                    We'd love to hear from you! Whether you have questions, feedback, or just want to connect, our team
                    is here to help.
                  </p>
                </div>
              </div>
