  ...
  const programs = [
    {
      ...
      image: "/placeholder.svg?key=mot71",
    },
    {
      title: "JEE Main Comprehensive",
      description: "Complete preparation for JEE Main covering both Class 11 and 12 syllabus",
      features: [
        "Comprehensive coverage of JEE Main syllabus",
        "Weekly mock tests based on JEE pattern",
      ...
      image: "/placeholder.svg?key=jq13m",
    },
    {
      ...
      suitable: "JEE Main qualified students",
      image: "/placeholder.svg?key=4wzqe",
    },
    {
      ...
      image: "/placeholder.svg?key=kv1st",
    },
    {
      title: "JEE Physics Mastery",
      description: "Specialized program focusing on Physics for JEE Main and Advanced",
      features: [
        "In-depth coverage of Physics concepts",
        "Extensive problem-solving practice",
        "Practical demonstrations of concepts",
        "Special focus on numerical problems",
      ],
      duration: "6 months",
      batchSize: "25 students",
      suitable: "Students weak in Physics",
      image: "/placeholder.svg?key=b7g35",
    },
    {
      title: "JEE Mathematics Excellence",
      description: "Specialized program focusing on Mathematics for JEE Main and Advanced",
      features: [
        "Comprehensive coverage of all Math topics",
        "Special techniques for complex problems",
        "Regular practice with JEE level questions",
        "Focus on time management strategies",
      ],
      duration: "6 months",
      batchSize: "25 students",
      suitable: "Students weak in Mathematics",
      image: "/placeholder.svg?key=2m9z6",
    },
  ]
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-slate-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-slate-400">
                  Comprehensive coaching programs designed to help you crack JEE Main and Advanced with top ranks
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-10">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-blue-950 dark:text-white">
                  Why Choose Our JEE Programs
                </h2>
                <p className="max-w-[900px] text-slate-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-slate-400">
                  What sets our JEE preparation programs apart from others
                </p>
              </div>
            </div>
                ...
                <Card className="bg-white dark:bg-slate-800 border-none shadow-md">
                  <CardContent className="p-6">
                    ...
                    <p className="text-slate-600 dark:text-slate-400">
                      Our faculty includes IIT alumni and experienced educators with proven track records of producing
                      top rankers.
                    </p>
                  </CardContent>
                </Card>
              ...
              <FadeIn delay={0.2} direction="up">
                <Card className="bg-white dark:bg-slate-800 border-none shadow-md">
                  <CardContent className="p-6">
                    ...
                    <p className="text-slate-600 dark:text-slate-400">
                      Meticulously designed study materials covering the entire JEE syllabus with practice questions at
              ...
              <FadeIn delay={0.3} direction="up">
                <Card className="bg-white dark:bg-slate-800 border-none shadow-md">
                  <CardContent className="p-6">
                    ...
                    <p className="text-slate-600 dark:text-slate-400">
                      Weekly tests and monthly mock exams based on the actual JEE pattern to track progress and build
                      exam temperament.
                    </p>
                  </CardContent>
                </Card>
              ...
              <FadeIn delay={0.4} direction="up">
                <Card className="bg-white dark:bg-slate-800 border-none shadow-md">
                  <CardContent className="p-6">
                    ...
                    <p className="text-slate-600 dark:text-slate-400">
                      Consistent track record of producing top rankers in JEE Main and Advanced with many students
                      securing admissions in IITs and NITs.
                    </p>
                  </CardContent>
                </Card>
              </FadeIn>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                  Ready to Begin Your JEE Preparation?
                </h2>
                <p className="max-w-[900px] text-blue-100 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Join our comprehensive JEE preparation programs and take the first step towards securing admission in
                  your dream engineering college.
                </p>
              </div>
