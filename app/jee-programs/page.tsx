...
import { ArrowRight, BookOpen, Calendar, CheckCircle, Clock, Award, Star, Trophy, Medal } from "lucide-react"
...
export const metadata: Metadata = generatePageMetadata({
  title: "JEE Programs | Toppers Maker",
  description:
    "Comprehensive JEE preparation programs for JEE Main and Advanced with expert faculty and proven results.",
  keywords: [
    "jee coaching",
  ...
  canonicalUrl: "/jee-programs",
})

export default function JEEProgramsPage() {
  const programTypes = [
    {
      name: "JEE Main Foundation",
      description: "A comprehensive foundation program for Class 11 students aiming for JEE Main",
      icon: <Star className="h-6 w-6 text-blue-600 dark:text-blue-400" />,
    },
    {
      name: "JEE Main Comprehensive",
      description: "Complete preparation for JEE Main covering both Class 11 and 12 syllabus",
      icon: <BookOpen className="h-6 w-6 text-blue-600 dark:text-blue-400" />,
    },
    {
      name: "JEE Advanced Elite",
      description: "Specialized program for students aiming for top ranks in JEE Advanced",
  ...
  const features = [
    {
      ...
      description: "Learn from IIT alumni and experienced educators with proven track records",
      icon: <Medal className="h-6 w-6 text-blue-600 dark:text-blue-400" />,
    },
    {
      title: "Comprehensive Study Material",
      description: "Meticulously designed study materials covering the entire JEE syllabus",
      icon: <BookOpen className="h-6 w-6 text-blue-600 dark:text-blue-400" />,
    },
    {
      title: "Regular Testing",
      description: "Weekly tests and monthly mock exams based on the actual JEE pattern",
      icon: <Clock className="h-6 w-6 text-blue-600 dark:text-blue-400" />,
    },
    {
      title: "Problem Solving Sessions",
      description: "Dedicated sessions to tackle complex JEE problems",
  ...
  return (
    <main className="pt-24">
      <div className="container mx-auto px-4 py-4">
        <Breadcrumbs
          items={[
            ...
            { name: "JEE Programs", href: "/jee-programs" },
          ]}
        />
      </div>
      {/* Hero Section */}
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-blue-50 to-white dark:from-slate-800 dark:to-slate-900 transition-colors duration-300">
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
            <FadeIn direction="left" className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-slate-600 dark:text-slate-300 md:text-xl transition-colors duration-300">
                  Comprehensive coaching for JEE Main and Advanced to excel in engineering entrance examinations.
                </p>
              </div>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                <Link href="/get-enrolled">
                  <Button
                    size="lg"
                    className="gap-1 bg-blue-600 hover:bg-blue-700 text-white dark:bg-blue-700 dark:hover:bg-blue-600 dark:text-white transition-colors duration-300"
                  >
            ...
            <FadeIn direction="right" delay={0.2} className="flex items-center justify-center">
              <div className="relative rounded-lg overflow-hidden shadow-lg dark:shadow-blue-900/20">
                <Image
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-white dark:bg-slate-900 transition-colors duration-300">
        <div className="container px-4 md:px-6">
          <SectionHeading
            title="JEE Programs We Offer"
            description="Comprehensive coaching for various JEE preparation needs"
            className="text-center"
          />
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
            {programTypes.map((type, index) => (
              <FadeIn key={index} delay={0.1 * index} direction="up">
                <div className="flex flex-col p-6 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-slate-200 dark:border-slate-700 h-full transition-colors duration-300 hover:shadow-xl dark:hover:shadow-blue-900/10">
                  <div className="rounded-full bg-blue-100 dark:bg-blue-900/50 p-3 w-12 h-12 flex items-center justify-center mb-4 transition-colors duration-300">
                    {type.icon}
                  </div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-blue-50 dark:bg-slate-800 transition-colors duration-300">
        <div className="container px-4 md:px-6">
          <SectionHeading
            title="Why Choose Our JEE Programs"
            description="What sets our JEE coaching apart"
            className="text-center"
          />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {features.map((feature, index) => (
              <FadeIn key={index} delay={0.1 * index} direction="up">
                <div className="flex p-4 bg-white dark:bg-slate-900 rounded-lg shadow border border-slate-200 dark:border-slate-700 transition-colors duration-300 hover:shadow-md dark:hover:shadow-blue-900/10">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-blue-600 dark:bg-blue-800 text-white transition-colors duration-300">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-white dark:text-white transition-colors duration-300">
              ...
              <p className="mx-auto max-w-[700px] text-blue-100 dark:text-blue-50 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed transition-colors duration-300">
                Join our specialized JEE programs and get the guidance you need to succeed in engineering entrance
                exams.
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
