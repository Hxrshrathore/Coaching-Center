...
export default function ToppersTalesPage() {
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 italic">
                      "The structured approach and personal mentoring at Ascent Classes helped me crack NEET with a top
                      rank. The faculty's guidance was invaluable throughout my preparation journey."
                    </p>
                  </div>
                  <div className="space-y-2 pt-4">
                    ...
                    <p className="text-slate-600 dark:text-slate-400">
                      ...
                      everything for me. The faculty identified my strengths in Biology and helped me improve my Physics
                      and Chemistry. The weekly tests kept me on my toes, and the personalized feedback sessions helped
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <FadeIn delay={0.1} direction="up">
                <Card className="bg-white dark:bg-slate-800 border-none shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <CardContent>
                    <p className="text-slate-600 dark:text-slate-400">
                      "Regular study with a fixed schedule is more important than studying for long hours irregularly. I
                      maintained a consistent 6-hour study routine apart from coaching classes."
                    </p>
              ...
              <FadeIn delay={0.2} direction="up">
                <Card className="bg-white dark:bg-slate-800 border-none shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <CardContent>
                    <p className="text-slate-600 dark:text-slate-400">
                      "Don't just memorize concepts; understand them thoroughly. This helped me solve even the trickiest
                      problems in JEE. I always asked 'why' until I fully understood each concept."
                    </p>
                    <div className="mt-4 flex items-center gap-2">
                      <div className="relative h-8 w-8 overflow-hidden rounded-full">
              ...
              <FadeIn delay={0.5} direction="up">
                <Card className="bg-white dark:bg-slate-800 border-none shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <CardContent>
                    <p className="text-slate-600 dark:text-slate-400">
                      "I focused on quality study material rather than quantity. The comprehensive material provided by
                      Ascent Classes was sufficient. I created short notes for quick revision during the final days."
                    </p>
                    <div className="mt-4 flex items-center gap-2">
                      <div className="relative h-8 w-8 overflow-hidden rounded-full">
                        <Image
              ...
              <FadeIn delay={0.6} direction="up">
                <Card className="bg-white dark:bg-slate-800 border-none shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <CardContent>
                    <p className="text-slate-600 dark:text-slate-400">
                      "Maintaining a positive mindset throughout the preparation journey is crucial. I surrounded myself
                      with positive people and focused on my progress rather than comparing with others."
                    </p>
                    <div className="mt-4 flex items-center gap-2">
                      <div className="relative h-8 w-8 overflow-hidden rounded-full">
