            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="bg-white dark:bg-slate-800 border-none shadow-md">
                ...
                <CardContent className="text-center">
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Former IIT Delhi professor with 15+ years of experience in teaching Physics for JEE. Specializes in
              ...
              <Card className="bg-white dark:bg-slate-800 border-none shadow-md">
                ...
                <CardContent className="text-center">
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Former CSIR scientist with extensive experience in teaching Organic and Inorganic Chemistry. Author
                    of several reference books for competitive exams.
                  </p>
                  <div className="mt-4 flex justify-center gap-2">
                    <Badge
                      variant="outline"
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center space-y-4 md:order-3">
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Our library has been completely renovated with an expanded collection of books, journals, and digital
                  resources. The new space includes quiet study areas, group discussion rooms, and comfortable reading
                  zones.
                </p>
                <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
                  <li className="flex items-center gap-2">
