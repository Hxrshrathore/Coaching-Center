...
export const metadata: Metadata = {
  title: "JEE Preparation Program | Ascent Coaching Classes",
  description:
    "Comprehensive JEE preparation program designed to help students excel in JEE Main and Advanced examinations.",
  openGraph: {
    title: "JEE Preparation Program | Ascent Coaching Classes",
    description:
      "Comprehensive JEE preparation program designed to help students excel in JEE Main and Advanced examinations.",
    url: "/program-path/jee",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg shadow-sm border border-slate-100 p-6">
                ...
                <p className="text-slate-600">
                  "The structured approach and regular mock tests at Ascent helped me secure AIR 235 in JEE Advanced.
                  The faculty's guidance was invaluable."
                </p>
              </div>
              <div className="bg-white rounded-lg shadow-sm border border-slate-100 p-6">
                <div className="flex items-center mb-4">
                ...
                <p className="text-slate-600">
                  "The problem-solving techniques taught at Ascent were game-changers for me. I improved my ranking
                  significantly in just 6 months."
                </p>
              </div>
              <div className="bg-white rounded-lg shadow-sm border border-slate-100 p-6">
                <div className="flex items-center mb-4">
                ...
                <p className="text-slate-600">
                  "The faculty at Ascent doesn't just teach concepts but ensures you understand the application. This
                  approach helped me excel in JEE."
                </p>
              </div>
            </div>
          ...
          <FadeIn>
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-slate-100 p-6">
                ...
                <p className="text-slate-600">
                  We recommend 2-3 hours of self-study daily in addition to the classroom sessions. During vacations and
                  weekends, this can be increased to 4-5 hours.
                </p>
              </div>
              <div className="bg-white rounded-lg shadow-sm border border-slate-100 p-6">
