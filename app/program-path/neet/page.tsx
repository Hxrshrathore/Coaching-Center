...
export const metadata: Metadata = {
  title: "NEET Preparation Program | Ascent Coaching Classes",
  description:
    "Comprehensive NEET preparation program designed to help students excel in medical entrance examinations.",
  openGraph: {
    title: "NEET Preparation Program | Ascent Coaching Classes",
    description:
      "Comprehensive NEET preparation program designed to help students excel in medical entrance examinations.",
    url: "/program-path/neet",
          ...
          <FadeIn>
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-lg text-slate-600">
                Our specialized approach has helped thousands of students achieve their dream of studying in top medical
                colleges.
              </p>
            </div>
          ...
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-slate-100 p-6">
                ...
                <p className="text-slate-600">
                  "The study materials provided by Ascent are comprehensive and cover all topics in detail. This helped
                  me score well in NEET."
                </p>
              </div>
            </div>
